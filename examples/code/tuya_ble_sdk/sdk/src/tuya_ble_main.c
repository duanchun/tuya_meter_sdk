...
//    adv_data[adv_data_length+1] = 0x03;
//    adv_data[adv_data_length+2] = LO_UINT16(HID_SERV_UUID);
//    adv_data[adv_data_length+3] = HI_UINT16(HID_SERV_UUID);
//    tuya_ble_gap_advertising_adv_data_update(adv_data,adv_data_length+4);

    //TUYA_APP_LOG_HEXDUMP_INFO("RSP:", scan_rsp_data, scan_rsp_data_length);
...
//    TUYA_APP_LOG_HEXDUMP_INFO("ADV:", adv_data,adv_data_length);
