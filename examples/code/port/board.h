...
#if 0
#define BOARD_FLASH_HID_BOND_INFO_ADDR          (0x70000)
...
#else
#define BOARD_FLASH_EBIKE_CONFIG_INFO_ADDR      (0x75000)
#define BOARD_FLASH_HID_BOND_INFO_ADDR          (0x77000)
#define BOARD_FLASH_TUYA_INFO_START_ADDR        (0x78000)
#define BOARD_FLASH_OTA_INFO_ADDR               (0x7C000)
//#define BOARD_FLASH_MAC_START_ADDR  

#endif

#define BOARD_PWM_PIN                           11
#define BOARD_ADC_CHANNEL                       1
